...
<task type="auto">
  ...
  <action>
    ...
    - Export `getAnswersForSection(section: BidSection, allAnswers: Record<string, unknown>): Record<string, unknown>` — extracts only the answers relevant to a given section by iterating over section.sourceQuestions.
